...
<div class="main-header">
    ...
    <p>Tác giả: Nguyễn Phương Loan - Trường Tiểu Hùng An - ĐT: 0919758343</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nguyễn Phương Loan - Trường Tiểu Học Hùng An - ĐT: 0919758 343</div>", unsafe_allow_html=True)
